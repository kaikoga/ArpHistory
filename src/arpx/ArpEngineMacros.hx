...
class ArpEngineMacros {
	...
	private function new() {
		...
		components.push(new ArpEngineBackend("arp_display_backend", ["heaps", "flash", "openfl", "stub", null]));
		components.push(new ArpEngineBackend("arp_input_backend", ["heaps", "flash", "openfl", "stub", null]));
		components.push(new ArpEngineBackend("arp_audio_backend", ["heaps", "flash", "openfl", "stub", null]));
		components.push(new ArpEngineBackend("arp_socket_backend", ["flash", "openfl", "stub", null]));
		components.push(new ArpEngineBackend("arp_storage_backend", ["flash", "openfl", "stub", null]));

		var root:ArpEngineBackend = new ArpEngineBackend("arp_backend", ["heaps", "flash", "openfl", "stub", null]);
