...
import net.kaikoga.arp.seed.impl.ArpSeedSimpleAmbigiousValue;
import net.kaikoga.arp.seed.impl.ArpSeedSimpleLiteralValue;
import net.kaikoga.arp.seed.impl.ArpSeedSimpleReferenceValue;
