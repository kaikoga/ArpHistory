...
class MacroArpObjectMapField extends MacroArpObjectFieldBase implements IMacroArpObjectField {
	...
	public function buildInitBlock(initBlock:Array<Expr>):Void {
		...
		if (this.definition.nativeDefault == null) {
			...
			initBlock.push(macro @:pos(this.nativePos) { this.$iFieldName = new net.kaikoga.arp.ds.impl.StdMap<String, $contentNativeType>(); });
		}
	}
