package net.kaikoga.arpx.backends.heaps.socketClient;
...
class TcpCachedSocketClientHeapsImpl extends ArpObjectImplBase implements ISocketClientImpl {
	...
	private function reconnect():Void {
		this.socketClient.arpDomain.log("socketClient", "TcpCachedSocketClientHeapsImpl.reconnect()");
		this.connect();
	}
