package net.kaikoga.arpx.backends.kha.socketClient;
...
class TcpCachedSocketClientKhaImpl extends ArpObjectImplBase implements ISocketClientImpl {
	...
	private function reconnect():Void {
		this.socketClient.arpDomain.log("socketClient", "TcpCachedSocketClientKhaImpl.reconnect()");
		this.connect();
	}
