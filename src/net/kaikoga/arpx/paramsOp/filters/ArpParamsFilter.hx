...
class ArpParamsFilter implements IArpParamsRead {
	...
	public function getInt(key:String, defaultValue:Int = null):Null<Int> return ArpParamsMacros.getSafe(key, defaultValue);
	public function getFloat(key:String, defaultValue:Float = null):Null<Float> return ArpParamsMacros.getSafe(key, defaultValue);
	public function getString(key:String, defaultValue:String = null):String return ArpParamsMacros.getSafe(key, defaultValue);
	public function getBool(key:String, defaultValue:Bool = null):Null<Bool> return ArpParamsMacros.getSafe(key, defaultValue);
	public function getArpDirection(key:String, defaultValue:ArpDirection = null):ArpDirection return ArpParamsMacros.getSafe(key, defaultValue);
