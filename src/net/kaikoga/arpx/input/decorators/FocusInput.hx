...
import net.kaikoga.arpx.impl.backends.flash.input.decorators.FocusInputFlashImpl;
#elseif arp_backend_heaps
import net.kaikoga.arpx.impl.backends.heaps.input.decorators.FocusInputHeapsImpl;
#end
