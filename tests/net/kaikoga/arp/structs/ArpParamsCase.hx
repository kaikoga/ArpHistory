...
class ArpParamsCase {
	...
	public function testAddParam():Void {
		var params:Dynamic = new ArpParams();
		params.a = "b";
		params.c = 10;
	...
	public function testToString():Void {
		...
		params.c = 10;
		assertMatch(["a:b", "c:10"], Std.string(params).split(","));
		params.d = ArpDirection.LEFT;
		assertMatch(["a:b", "c:10", "d:2147483648:dir"], Std.string(params).split(","));
		params.g = new ArpParamRewire("h");
		assertMatch(["a:b", "c:10", "d:2147483648:dir", "g:h:rewire"], Std.string(params).split(","));
	}
	...
	public function testClone():Void {
		...
		params.d = ArpDirection.LEFT;
		params.g = new ArpParamRewire("h");
		var params2:Dynamic = params.clone();
	...
	public function testCopyFrom():Void {
		...
		params.d = ArpDirection.LEFT;
		params.g = new ArpParamRewire("h");
		var params2:Dynamic = new ArpParams().addParam("e", "f").copyFrom(params);
		assertEquals(params.a, params2.a);
		assertEquals(params.c, params2.c);
		assertEquals(params.d.value, params2.d.value);
