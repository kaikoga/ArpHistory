...
class ArpSeedCase {
	...
	public function testEmptyXmlSeed():Void {
		...
		assertMatch({typeName: "root", template: null, name: null, ref: null, key: autoKey, value: null}, toHash(seed));
	...
	public function testSimpleXmlSeed():Void {
		...
		assertMatch({typeName: "value", template: null, name: null, ref: null, key: autoKey, value: "value42"}, toHash(iterator.next()));
		assertFalse(iterator.hasNext());
	}
	...
	public function testXmlSeedWithValue():Void {
		...
		var seed:ArpSeed = ArpSeed.fromXml(xml);
		assertTrue(seed.isSimple());
		assertMatch({typeName: "data", template: null, name: null, ref: null, key: autoKey, value: "value128"}, toHash(seed));
		var iterator = seed.iterator();
		assertTrue(iterator.hasNext());
		assertMatch({typeName: "value", template: null, name: null, ref: null, key: autoKey, value: "value128"}, toHash(iterator.next()));
		assertFalse(iterator.hasNext());
	}
	...
	public function testXmlSeedWithAttrValue():Void {
		...
		assertMatch({typeName: "data", template: "template14", name: "name6", ref: "ref8", key: autoKey, value: null}, toHash(seed));
		var iterator = seed.iterator();
		assertTrue(iterator.hasNext());
		assertMatch({typeName: "valueKey", template: null, name: null, ref: "value42", key: autoKey, value: "value42"}, toHash(iterator.next()));
		assertFalse(iterator.hasNext());
	}
	...
	public function testXmlSeedWithComplexValue():Void {
		...
		var seed:ArpSeed = ArpSeed.fromXml(xml);
		assertFalse(seed.isSimple());
		assertMatch({typeName: "data", template: null, name: null, ref: null, key: autoKey, value: "value16value32value64"}, toHash(seed));
		var iterator = seed.iterator();
		assertTrue(iterator.hasNext());
		assertMatch({typeName: "a", template: null, name: null, ref: null, key: autoKey, value: null}, toHash(iterator.next()));
		assertTrue(iterator.hasNext());
		assertMatch({typeName: "b", template: null, name: null, ref: null, key: autoKey, value: "valueb"}, toHash(iterator.next()));
		assertTrue(iterator.hasNext());
		assertMatch({typeName: "value", template: null, name: null, ref: null, key: autoKey, value: "value16value32value64"}, toHash(iterator.next()));
		assertFalse(iterator.hasNext());
	}
